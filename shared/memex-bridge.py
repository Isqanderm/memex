"""
Memex MCP bridge — canonical implementation shared by all agent integrations.

Requires: mcp, httpx
Env:      MEMEX_URL (default: http://memex:8000)

For platform-specific setup see:
  hermes/memex-bridge.py   — Hermes wrapper + install docs
  openclaw/memex-bridge.py — OpenClaw wrapper + install docs
